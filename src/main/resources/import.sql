...
insert into produto (id, nome, valor) values (2, 'Smartphone', 950.0);
insert into produto (id, nome, valor) values (3, 'Tablet', 1950.0);

insert into venda (id, cliente_id, frete, total, cadastro) values (1, 1,15.0, 950.0, sysdate());
